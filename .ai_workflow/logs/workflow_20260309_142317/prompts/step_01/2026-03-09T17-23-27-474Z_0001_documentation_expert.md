...
**Timestamp:** 2026-03-09T17:23:27.474Z
...
**Your assigned file (EDIT THIS FILE ONLY)**: README.md, docs/README.md

> You are responsible for ONE file: `README.md, docs/README.md`.
> All other files in "Changed files" are read-only context to inform your edits.
> Do NOT provide before/after edit blocks for any file other than `README.md, docs/README.md`.
...
2. **Identify documentation impact**: Determine what in `README.md, docs/README.md` needs updating based on the changed files
3. **Determine changes**: Identify exact sections of `README.md, docs/README.md` requiring updates
4. **Verify accuracy**: Ensure examples and references in `README.md, docs/README.md` are still correct

**OUTPUT FORMAT**:
- Provide before/after edit blocks ONLY for `README.md, docs/README.md`
- If no changes needed to `README.md, docs/README.md`, explicitly say "No updates required"
...
2. **Scope**: Edit ONLY `README.md, docs/README.md`. Use all other file contents as read-only context.
   Do not produce before/after blocks for any file other than `README.md, docs/README.md`.
...
## Scope Notes
- No additional files require documentation updates based on the provided context. All references, examples, and cross-links in `README.md` and `docs/README.md` are accurate and up-to-date with the current project state.
```