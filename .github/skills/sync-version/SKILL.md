...
.workflow-config.yaml        | version: 0.12.16-alpha | version: 0.12.3-alpha | ✗ MISMATCH
docs/ROADMAP.md              | (v0.12.16-alpha)       | (v0.11.0-alpha)       | ✗ MISMATCH
```
...
════════════════════════════════════════════
Canonical version: 0.12.16-alpha
─────────────────────────────────────────────
File                         Status
...
✅  Committed: chore(version): sync all version strings to 0.12.16-alpha
════════════════════════════════════════════
```
...
```
✅  sync-version: all version strings already agree with package.json (0.12.16-alpha)
