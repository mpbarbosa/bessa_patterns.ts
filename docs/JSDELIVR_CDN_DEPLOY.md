...
Replace `<version>` with the exact semver string (e.g. `0.12.14-alpha`).

| File | Dist-tag URL | Pinned URL |
|------|-------------|------------|
| ESM bundle | `…/npm/bessa_patterns.ts@alpha/dist/index.mjs` | `…/npm/bessa_patterns.ts@0.12.14-alpha/dist/index.mjs` |
| CJS bundle | `…/npm/bessa_patterns.ts@alpha/dist/index.cjs` | `…/npm/bessa_patterns.ts@0.12.14-alpha/dist/index.cjs` |
| Types | `…/npm/bessa_patterns.ts@alpha/dist/index.d.ts` | `…/npm/bessa_patterns.ts@0.12.14-alpha/dist/index.d.ts` |
...
{
  "imports": {
    "bessa_patterns.ts": "https://cdn.jsdelivr.net/npm/bessa_patterns.ts@0.12.14-alpha/dist/index.mjs"
  }
}
</script>
...
```
https://cdn.jsdelivr.net/npm/bessa_patterns.ts@0.12.14-alpha/
```
...
curl "https://purge.jsdelivr.net/npm/bessa_patterns.ts@0.12.14-alpha/dist/index.mjs"
