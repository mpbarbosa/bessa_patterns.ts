...
## Current State (v0.12.13-alpha / main)
...
| `CallbackRegistry`    | 0.12.13-alpha | Type-safe named-callback registry — register, execute, unregister, error-isolated            |
...
## v0.12.13-alpha — CallbackRegistry ✅
