...
## Current State (v0.12.14-alpha / main)
...
| `CallbackRegistry`    | 0.12.14-alpha | Type-safe named-callback registry — register, execute, unregister, error-isolated            |
...
## v0.12.14-alpha — CallbackRegistry ✅
